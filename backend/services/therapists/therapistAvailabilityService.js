...
//             availability.selected_time_slots[date] = availability.selected_time_slots[date].filter(slot => slot !== timeSlot);

//             if (availability.selected_time_slots[date].length === 0) {
//                 delete availability.selected_time_slots[date]; //  Remove empty dates
//             }
//         }
