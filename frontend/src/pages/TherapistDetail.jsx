...
// import { fetchTherapistById } from "../services/therapistApi";
// import { fetchTherapistAvailability } from "../services/therapistApi";
...
//   return (
//     <div className="p-4">
//       <h2 className="text-xl font-bold mb-2">{therapist.User?.username}</h2>
...
//               {new Date(date).toLocaleDateString()} {/* e.g. "3/10/2025" */}
//             </h4>
//             {/* Check if there's an array of times for this date */}
//             {timeSlots[date] && timeSlots[date].length > 0 ? (
//               timeSlots[date].map((time, idx) => (
//                 <div key={idx} className="flex items-center justify-between w-1/2 bg-gray-50 p-2 mb-2 rounded">
//                   <span>{time}</span>
//                   <button
